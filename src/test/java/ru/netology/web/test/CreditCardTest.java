...
public class CreditCardTest {
    ...
    class PurchaseByCardWithDifferentStatus {
        @Test
        void shouldPurshaseWithApprovedCreditCard() {
            ...
            assertEquals("APPROVED", BdHelper.getPaymentStatusByCreditCard());
        }
        ...
        void shouldPurchaseWithDeclinedCreditCard() {
            ...
            assertEquals("DECLINED", BdHelper.getPaymentStatusByCreditCard());
        }
    }
